...
export class Points {
    ...
    plus = (otherPoints)=> new Points(this.value + otherPoints.value, this.maxValue + otherPoints.maxValue);
...
export const constructMCS = (graph1, graph2, leastElementSimilarity = 1) => {
    /*
